...
# 2020: DRT_NNIS_raw <- read_excel(here(file = "C:/Users/dylan/OneDrive/Desktop/SAMO/Automation/raw data/qry_2020_DRT_CountOfNNIS_perTransect2.xlsx"))

# 2021 from Github
DRT_NNIS_raw <- read_excel(here(file = "qry_2021_DRT_CountOfNNIS_perTransect.xlsx"))
# make dataframe
...
poe_pt_raw <- read_excel(here(file = "raw_POE_WeedSurveyPt_2016to2020.xlsx"))
# Keep certain rows
...
poe_ln_raw <- read_excel(here(file = "C:/Users/dylan/OneDrive/Desktop/SAMO/Automation/raw data/raw_POE_WeedSurveyLn_2016to2020.xlsx"))
...
poe_loc_key <- read_excel(here(file = "C:/Users/dylan/OneDrive/Desktop/SAMO/Automation/POE_WeedSurveyLn&Pt_2016to2020.xlsx"), sheet = 3)
...
```{r}
spp_key <- read_excel(here(file = "C:/Users/dylan/OneDrive/Desktop/SAMO/Automation/SAMO's 25 Target Invasive Species.xlsx"), sheet=2, col_names = c("Scientific_name", "common_name", "six_let", "four_let", "USDA"), skip = 4)
...
ranges <- c("0", rep("1-2", 2), rep("3-5", 3), rep("6-10", 4), rep("11-13", 3))
...
Numspp_poe_range$ranges <- factor(Numspp_poe_range$ranges, levels= c("0", "1-2", "3-5", "6-10", "11-13"))
